...
func InitOptionMap() {
	...
	common.OptionMap["RateLimitExemptIPWhitelist"] = ""
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "InvitationCodeRequired" || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
	...
	case "RateLimitExemptIPWhitelist":
		err = setting.UpdateRateLimitExemptIPWhitelist(value)
	case "RetryTimes":
